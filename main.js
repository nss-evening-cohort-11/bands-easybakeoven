...
const purple = ["Puff Puff Pass", "Roll it up", "Mary Jane, My Love", "Shotgun Heaven", "Job 1.5", "Bongs Delight"];
const weed = ["Cabbage for all", "Up in smoke", "Toasted", "Let's get blunt", "Running on plants", "High O'clock"];
...
const cardWeed = (albums) => {
    let domString = "";
      for (let i = 0; i < albums.length;i++);
       ...
       {
       domString +='<div class="card" style="width: 18rem;">';
       domString +=  '<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQIZCQYo6AX0xcNLq7MtfkdWCOFnhD_U6BzLFnFyAvihz5qn_mP" class="card-img-top" alt="Weed Resort">';
       domString += '<div class="card-body">';
