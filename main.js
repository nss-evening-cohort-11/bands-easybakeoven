...
const cardWeed = (albums) => {
    let domString = "";
      for (let i = 0; i < albums.length;i++);
       ...
       {
       domString +='<div class="card" style="width: 18rem;">';
       domString +=  '<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQIZCQYo6AX0xcNLq7MtfkdWCOFnhD_U6BzLFnFyAvihz5qn_mP" class="card-img-album" alt="Weed Resort">';
       domString += '<div class="card-body">';
